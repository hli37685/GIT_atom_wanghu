...
----------------------------------------------------------------------------------------------
game_cmd.SUB_GP_QUERY_BIND_PHONE_VALIDCODE 			= 601	  							--绑定手机短信验证码
game_cmd.SUB_GP_BIND_PHONE  			            = 602	  							--绑定手机

-- 绑定手机
game_cmd.CMD_GP_Bind_Phone = 
{
	-- 用户id
	{t = "dword", k = "dwUserID"},
	...
	-- 手机号码
	{t = "tchar", k = "szMobilePhone", s = yl.LEN_MOBILE_PHONE},

	-- 验证码
	{t = "tchar", k = "szPhoneValidCode", s = yl.LEN_PHONE_CODE},
}

-- 绑定手机查询短信验证码
game_cmd.CMD_GP_Query_Bind_Phone_Code = 
{
	-- 用户id
	{t = "dword", k = "dwUserID"},
