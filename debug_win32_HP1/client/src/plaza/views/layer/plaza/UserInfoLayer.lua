...
--    btnHead:addTouchEventListener(btnHeadcallback)
	...
	display.newSprite("Information/text_info_id.png")
		...
		:addTo(self)
	--]]
	cc.Label:createWithTTF("ID:", "fonts/round_body.ttf", 28)
	...
	cc.Label:createWithTTF("性别:", "fonts/round_body.ttf", 28)
		...
		:move(565,466)
		:addTo(self)
	cc.Label:createWithTTF("昵称:", "fonts/round_body.ttf", 28)
		:setTextColor(cc.c4b(146,251,255,255))
		:setAnchorPoint(cc.p(1,0.5))
		:setDimensions(200,60)
		:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
		...
		:move(565,412)
		:addTo(self)
	cc.Label:createWithTTF("携带金币:", "fonts/round_body.ttf", 28)
		:setTextColor(cc.c4b(146,251,255,255))
		:setAnchorPoint(cc.p(1,0.5))
		:setDimensions(200,60)
		:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
	...
	self._txtScore:setPosition(620, 358)
    ...
    local spriteSigneBg = cc.Scale9Sprite:create("Information/info_frame_1.png")
        ...
        spriteSigneBg:setContentSize(cc.size(700, 140))
        spriteSigneBg:move(yl.WIDTH/2,250)
	...
	self.edit_Sign = ccui.EditBox:create(cc.size(610,40), "blank.png")
		:move(670,290)
		:setAnchorPoint(cc.p(0.5,0.5))
		:setFontName("fonts/round_body.ttf")
		:setPlaceholderFontName("fonts/round_body.ttf")
        ...
        :setContentSize(610,120)
		:setMaxLength(32)
		--:setInputMode(cc.EDITBOX_INPUT_MODE_SINGLELINE)
		:setPlaceHolder("请输入您的个人签名")
		:setFontColor(cc.c4b(146,215,255,255))
		:setPlaceholderFontColor(cc.c4b(88,127,186,255))
