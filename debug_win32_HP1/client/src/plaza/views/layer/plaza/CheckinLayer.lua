...
function CheckinLayer:ctor(scene)
    ...
    local line1StartPosX =  480
    local line2StartPosX =  375
    local ItemIntervalX = 190
    local ItemIntervalY = 170
    local line1StartPosY = 465
	--签到展示区域
...
function CheckinLayer:setCheckinBtn(enable, hide)
    ...
    if bg then
        ...
        self.m_btnCheckinBg:setPosition(yl.WIDTH/2,170)
