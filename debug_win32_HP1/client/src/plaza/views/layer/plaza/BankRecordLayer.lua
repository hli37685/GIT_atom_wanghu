...
--			end)
    ...
    spriteContentBg:setContentSize(cc.size(1200, 550))
    spriteContentBg:setPosition(yl.WIDTH/2, yl.HEIGHT/2 -30)
...
--		:addTo(self)
	...
	self._listView:setPosition(cc.p(90,112))
...
--		:addTo(cell)
    ...
    local spriteContentBg = cc.Scale9Sprite:create("BankRecord/hr.png")
    spriteContentBg:setCapInsets(CCRectMake(1,1,773,1))
    spriteContentBg:setContentSize(cc.size(width, height))
    spriteContentBg:setPosition(width/2-5, -35)
    cell:addChild(spriteContentBg)

	--日期
	local date = os.date("%Y/%m/%d %H:%M:%S", tonumber(item.date)/1000)
	-- print(date)
	-- print(""..tonumber(item.date))
	cc.Label:createWithTTF(date,"fonts/round_body.ttf",29)
		:move(142,height/2)
		:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
	...
	cc.Label:createWithTTF(item.tradeType,"fonts/round_body.ttf",29)
		:move(412,height/2)
		:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
		:setTextColor(cc.c4b(255,255,255,255))
		:setAnchorPoint(cc.p(0.5,0.5))
	...
	cc.Label:createWithTTF(string.formatNumberThousands(item.swapScore,true,","),"fonts/round_body.ttf",29)
		:move(612,height/2)
		:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
		:setTextColor(cc.c4b(255,255,255,255))
		:setAnchorPoint(cc.p(0.5,0.5))
	...
	cc.Label:createWithTTF(item.id,"fonts/round_body.ttf",29)
		:move(812,height/2)
		:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
		:setTextColor(cc.c4b(255,255,255,255))
		:setAnchorPoint(cc.p(0.5,0.5))
	...
	cc.Label:createWithTTF(string.formatNumberThousands(item.revenue,true,","),"fonts/round_body.ttf",29)
		:move(1028,height/2)
		:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
		:setTextColor(cc.c4b(255,255,255,255))
		:setAnchorPoint(cc.p(0.5,0.5))
