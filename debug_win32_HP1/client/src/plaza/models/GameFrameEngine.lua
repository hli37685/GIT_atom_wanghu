...
function GameFrameEngine:onConnectCompeleted()
	...
	dataBuffer:pushstring(GlobalUserItem.szloginPasswords,33)
...
function GameFrameEngine:onSocketUserStatus(dataBuffer)
 ...
 --   just_output("GameFrameEngine:onSocketUserStatus oldtable:"..self._UserList[dwUserID].wTableID..", oldchair:"..self._UserList[dwUserID].wChairID)
--    if newstatus.cbUserStatus < yl.US_SIT then
--        just_output("GameFrameEngine:onSocketUserStatus newstatus.cbUserStatus < yl.US_SIT")
--    end 

	--过滤观看
	if newstatus.cbUserStatus == yl.US_LOOKON then
--        if newstatus.cbUserStatus < yl.US_SIT then
--            just_output("GameFrameEngine:onSocketUserStatus return0")
--        end 
		return
	end
...
--            if newstatus.cbUserStatus < yl.US_SIT then
--                just_output("GameFrameEngine:onSocketUserStatus return1")
--            end 
...
--        if newstatus.cbUserStatus < yl.US_SIT then
--            just_output("GameFrameEngine:onSocketUserStatus return2")
--        end 
...
--        if newstatus.cbUserStatus < yl.US_SIT then
--            just_output("GameFrameEngine:onSocketUserStatus return3")
--        end 
...
--    if newstatus.cbUserStatus < yl.US_SIT and oldstatus.cbUserStatus > yl.US_FREE then
--        just_output("GameFrameEngine:onSocketUserStatus need clear oldtable:"..oldstatus.wTableID..", oldchair:"..oldstatus.wChairID..", newtable:"..newstatus.wTableID..",newchairid:"..newstatus.wChairID)
--    end 
  ...
  --          just_output("GameFrameEngine:onSocketUserStatus have been cleared oldtable:"..oldstatus.wTableID..", oldchair:"..oldstatus.wChairID..", newtable:"..newstatus.wTableID..",newchairid:"..newstatus.wChairID)
