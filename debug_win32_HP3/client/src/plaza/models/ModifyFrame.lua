...
function ModifyFrame:onSubOperateSuccess(pData)
	...
	if self._oprateCode == 1 then
		...
		--添加 修改 2017年9月2日14:24:29
		GlobalUserItem.szloginPasswords= md5(self._szLogonNew)
		--保存数据
...
function ModifyFrame:sendModifySystemFace( )
	...
	sysmodify:pushstring(GlobalUserItem.szloginPasswords,33)
...
--		showToast(runScene, "ModifyFrame:onBindingMachine => machine: " .. self._szMachine, 2, cc.c4b(250,0,0,255))
--	end
