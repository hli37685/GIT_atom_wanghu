...
yl.FRIENDPORT							= 8630 --@friend_port
--编译码
--yl.VALIDATE 							= "7BDE8DA0-330B-4E5F-8002-9B5EEDA32044" --@compilation
yl.VALIDATE 							= "69600029-E32E-4087-A6DC-E269F1004AB8" --@compilation


--http请求链接地址
--yl.HTTP_URL								= "http://ry.webfox.com" --@http_url
--yl.HTTP_URL								= "http://ry.webfox.com" --@http_url
yl.HTTP_URL								= "http://ww1.16yi.com" ----ethj  这个改成ww1.16yi.com

-- http请求支持(loginScene)
yl.HTTP_SUPPORT							= false
-- 是否显示信息弹窗的ip和位置信息
...
yl.SCENE_GAMECLASS                      = 40        --游戏分类

--游戏分类
yl.GAMECLASS_CARD                       = 1             --棋牌
yl.GAMECLASS_MULTI         		        = 2             --多人
yl.GAMECLASS_LEISURE                    = 3             --休闲
yl.GAMECLASS_FISH                       = 4             --捕鱼
...
yl.LEN_GAME_SERVER_ITEM					= 176			--房间长度
...
yl.SUB_MB_FORGET_PW_QUERY_CODE			= 9             --获取短信验证码
yl.SUB_MB_FORGET_PW_RESET				= 10            --密码重置
...
yl.SocialShare =
{
	title 								= "16亿棋牌中心（捕鱼,牛牛,水浒传集）", --@share_title_social
...
yl.WeChat = 
{
	...
	--AppID 								= "wxf37f681f66a5a277", --@wechat_appid_wx
	--AppSecret 							= "4a5e5f8408e28f9a4e4fc1da44970679", --@wechat_secret_wx
	--PartnerID 							= "1457410502", --@wechat_partnerid_wx
	--PayKey 								= "NnOCUBnWro8q5di7YIE0NzkBckAfq43M", --@wechat_paykey_wx
	
	--该id 未开通登录
	--AppID 								= "wx3466812a5fd674ed", --@wechat_appid_wx
	--AppSecret 							= "693ce1764caba0840d55a831ef41fa87", --@wechat_secret_wx 
	
	AppID 								= "wxa7f26a6b6f26e616", --@wechat_appid_wx
	AppSecret 							= "9a0af71bade24eaaeacebfe5cc0dc8fb", --@wechat_secret_wx 

	-- 商户id
	PartnerID 							= "1483287522", --@wechat_partnerid_wx
	-- 支付密钥					        
...
{
	-- 合作者身份id
	PartnerID							= "2017022705933569", --@alipay_partnerid_zfb
	-- 收款支付宝账号						
	SellerID							= "2017022705933569", --@alipay_sellerid_zfb
	-- rsa密钥
	RsaKey								= "11111", --@alipay_rsa_zfb
	NotifyURL							= yl.HTTP_URL .. "/Pay/notify_url.aspx",
	-- ios支付宝Schemes
	AliSchemes							= "wxa7f26a6b6f26e616", --@alipay_schemes_zfb
...
--平台id列表(服务器登陆用)
yl.PLATFORM_LIST = {}
yl.PLATFORM_LIST[yl.ThirdParty.WECHAT]	= 0
