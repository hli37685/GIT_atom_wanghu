...
--]] 
    ...
    self.txtFrame=cc.Scale9Sprite:create("Bank/moneyBox.png")
        --spriteSigneBg:setCapInsets(CCRectMake(43,40,479,44))
        :setContentSize(cc.size(344, 42))
		:move(yl.WIDTH/2+300,480)
		:addTo(self._takesaveArea)

	self.txtQian=display.newSprite("Bank/cunkan.png")
		:move(yl.WIDTH/2+110,480)
		:addTo(self._takesaveArea)

    self._txtInsure = cc.Label:createWithSystemFont(string.formatNumberThousands(GlobalUserItem.lUserInsure,true,","),"Arial", 26)	
    		:move(yl.WIDTH/2+160,480)
    		:setAnchorPoint(cc.p(0,0.5))
			:setTextColor(cc.c4b(255,214,115,255))
    		:addTo(self._takesaveArea)
    ...
    self.number_frame=cc.Scale9Sprite:create("Bank/moneyBox.png")
        ...
        :setContentSize(cc.size(350, 50))
		:move(720 ,400)
		:addTo(self._takesaveArea)

	self.number_label=display.newSprite("Bank/shuruje.png")
		:move(470,400)
		:addTo(self._takesaveArea)

	self.edit_Score = ccui.EditBox:create(cc.size(300,30), "")
		:move(570,400)
		:setAnchorPoint(cc.p(0,0.5))
		...
		:setPlaceHolder("")
		:setFontColor(cc.c4b(255,153,0,255))
...
--]]
    ...
    --金额大写提示
	---[[
    self.m_textNumber = ClipText:createClipText(cc.size(700,24), "", "fonts/round_body.ttf", 20)
    self:addChild(self.m_textNumber)
    self.m_textNumber:setPosition(550,360)
    self.m_textNumber:setAnchorPoint(cc.p(0,0.5))
    self.m_textNumber:setTextColor(cc.c4b(104,95,78,255))
    self.MainUIs[#self.MainUIs+1] = self.m_textNumber  
	--]] 

    --金额大写提示 -金币赠送
    self.m_textNumberJB = ClipText:createClipText(cc.size(700,24), "", "fonts/round_body.ttf", 20)
    self:addChild(self.m_textNumberJB)
    self.m_textNumberJB:setPosition(550,280)
    self.m_textNumberJB:setAnchorPoint(cc.p(0,0.5))
	self.m_textNumberJB:setVisible(false)
    self.m_textNumberJB:setTextColor(cc.c4b(104,95,78,255))
    ...
    self.edit_Password_label=display.newSprite("Bank/shurumm.png")
		:move(470,320)
		:addTo(self._takesaveArea)
	...
	-- 存款 确定
    self.cunkuan = display.newSprite("Bank/lianglvbtn.png")
		:move(yl.WIDTH/2-150, 210)
		:setScale(1)
		:addTo(self._takesaveArea)
    newBtnSize = self.cunkuan:getContentSize()
	ccui.Button:create("Bank/saveBank.png","Bank/saveBank.png")
		:move(newBtnSize.width/2, newBtnSize.height/2)
		:addTo(self.cunkuan)
	...
	-- 取款 确定
    self.qukuan = display.newSprite("Bank/lianglvbtn.png")
		:move(yl.WIDTH/2+150, 210)
		:setScale(1)
		:addTo(self._takesaveArea)
    newBtnSize = self.qukuan:getContentSize()
	ccui.Button:create("Bank/takeBank.png","Bank/takeBank.png")
		:move(newBtnSize.width/2, newBtnSize.height/2)
		:addTo(self.qukuan)
	...
	--修改密码 确定
	--[[
    self.xiugaimima = display.newSprite("Bank/lianglvbtn.png")
		:move(700, 220)
		:setScale(1)
		:setVisible(false)
		:addTo(self._takesaveArea)
	...
	--金币赠送 确定	 
    self.jinbizs = display.newSprite("Bank/lianglvbtn.png")
		:move(yl.WIDTH/2, 170)
		:setScale(1)
		:setVisible(false)
		:addTo(self._takesaveArea)
    newBtnSize = self.jinbizs:getContentSize()
	ccui.Button:create("Bank/regist_send.png","Bank/regist_send.png")
		:move(newBtnSize.width/2, newBtnSize.height/2)
		:addTo(self.jinbizs)
	...
	display.newSprite("Bank/duifangid.png")
		:move(470,400)
		:addTo(self._transferArea)
	...
	display.newSprite("Bank/shuruje.png")
		:move(470,320)
		:addTo(self._transferArea)
	...
	display.newSprite("Bank/shurumm.png")
		:move(470,240)
		:addTo(self._transferArea)
