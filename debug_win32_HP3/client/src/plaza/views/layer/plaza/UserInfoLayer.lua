...
--	local head = HeadSprite:createClipHead(GlobalUserItem, 40)
    local head = HeadSprite:createNormal(GlobalUserItem, 40)
...
function UserInfoLayer:ctor(scene)
    ...
    --spriteMainBg:setContentSize(cc.size(900, 560))
	...
	--携带金币
	--金币框背景
    cc.Scale9Sprite:create("Information/moneyBox.png")
        :setCapInsets(CCRectMake(22,21,300,0))
        :setContentSize(cc.size(344, 42))
		:setAnchorPoint(cc.p(0,0.5))
        :move(920, 700)
		:addTo(self)

	--金币图标
	display.newSprite("Information/icon_money.png")
		:move(920,700)
		:setScale(0.8)
		:addTo(self)
	--添加金币按钮
    ccui.Button:create("Information/qvqianbtn.png","Information/qvqianbtn.png")
	...
	--
	self._txtScore = ClipText:createClipText(cc.size(345,60), string.formatNumberThousands(GlobalUserItem.lUserScore,true), "fonts/round_body.ttf", 28)
	self._txtScore:setTextColor(cc.c4b(255,214,115,255))
	self._txtScore:setAnchorPoint(cc.p(0,0.5))
	self._txtScore:setPosition(950, 700)
...
--[[
    local head = HeadSprite:createNormal(GlobalUserItem, 142)
	head:setPosition(380, 460)
...
--    local head = display.newSprite("Information/grzl01.png")
--		    :move(380, 460)     
	self:addChild(head)
	self._head = head
--    local btnHead = ccui.Button:create("Information/grzl01.png", "Information/grzl01.png")
--    btnHead:setContentSize(head:getContentSize())
--    head:addChild(btnHead)
--    local this = self
--	local  btnHeadcallback = function(ref, type)
--        if type == ccui.TouchEventType.ended then
--         	this:onClickUserHead()
--        end
--    end
--    btnHead:addTouchEventListener(btnHeadcallback)
--]]

	--[[
	--头像背景
    local spriteHeadBg = cc.Scale9Sprite:create("Information/info_frame_1.png")
        spriteHeadBg:setCapInsets(CCRectMake(20,20,60,60))
        spriteHeadBg:setContentSize(cc.size(180, 200))
        spriteHeadBg:move(380, 460)
		spriteHeadBg:addTo(self)
	--]]

	--头像
    self._btPersonInfo=display.newSprite("Lobby/tx1.png")
    self._btPersonInfo:move(280, 480)
	self._btPersonInfo:addTo(self)
    ...
    self._btPersonInfo:setTexture(_personInfo)

	--账号
	display.newSprite("Information/zhanghao.png")
		:setAnchorPoint(cc.p(1,0.5))
		:move(505,540)
		:addTo(self)

	self._Account = cc.Label:createWithTTF(GlobalUserItem.szAccount, "fonts/round_body.ttf", 30)
	...
	--ID
	display.newSprite("Information/id.png")
		:setAnchorPoint(cc.p(1,0.5))
		:move(865,540)
		:addTo(self)

	local textId = string.format("%d", GlobalUserItem.dwGameID)
	self._txtID = cc.Label:createWithTTF(textId, "fonts/round_body.ttf", 30)
		:setTextColor(cc.c4b(255,255,255,255))
		:setAnchorPoint(cc.p(0,0.5))
		:setDimensions(345,60)
		:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
	...
	--]]
	--[[
	cc.Label:createWithTTF("性别:", "fonts/round_body.ttf", 28)
		:setTextColor(cc.c4b(146,251,255,255))
		:setAnchorPoint(cc.p(1,0.5))
		:setDimensions(200,60)
		:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
    ...
    --性别选择
	display.newSprite("Information/xingbie.png")
		:setAnchorPoint(cc.p(1,0.5))
		:move(505,390)
		:addTo(self)

    self._cbtMan = ccui.CheckBox:create("Information/checkbox_info_1.png","","Information/checkbox_info_0.png","","")
		:move(600,390)
		:setSelected(bGender)
		:addTo(self)
		:setTag(self.CBT_MAN)
	...
	--昵称
	display.newSprite("Information/nick.png")
		:setAnchorPoint(cc.p(1,0.5))
		:move(505,465)
		:addTo(self)
	...
	--框背景
    cc.Scale9Sprite:create("Information/srkdt.png")
        :setCapInsets(CCRectMake(40,25,400,0))
	...
	--输入框 游戏昵称
	self.edit_Nickname = ccui.EditBox:create(cc.size(390,40), "blank.png")
		:move(720,465)
		:setAnchorPoint(cc.p(0.5,0.5))
		:setFontName("fonts/round_body.ttf")
		:setPlaceholderFontName("fonts/round_body.ttf")
	...
	--签名
    local spriteSigneBg = cc.Scale9Sprite:create("Information/info_frame_1.png")
        --spriteSigneBg:setCapInsets(CCRectMake(43,40,479,44))
        spriteSigneBg:setContentSize(cc.size(1000, 140))
        spriteSigneBg:move(yl.WIDTH/2,220)
	    spriteSigneBg:addTo(self)

	cc.Label:createWithTTF("个性签名:", "fonts/round_body.ttf", 28)
		:setTextColor(cc.c4b(255,255,255,255))
		:setAnchorPoint(cc.p(1,0.5))
		:setDimensions(200,90)
		:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
		:setHorizontalAlignment(cc.TEXT_ALIGNMENT_RIGHT)
		:move(300,320)
		:addTo(self)

	self.edit_Sign = ccui.EditBox:create(cc.size(700,40), "blank.png")
		:move(900,220)
		:setAnchorPoint(cc.p(0.5,0.5))
		:setFontName("fonts/round_body.ttf")
		:setPlaceholderFontName("fonts/round_body.ttf")
...
print(GlobalUserItem.szSign)
	...
	--[[
	--修改密码
    local xiugaimmBg = display.newSprite("Information/lvbtn.png")
		:move(550, 370)
		:setScale(1)
		:addTo(self)
    local newBtnSize = xiugaimmBg:getContentSize()
	ccui.Button:create("Information/btnXiugaimm.png","Information/btnXiugaimm.png")
		:move(newBtnSize.width/2, newBtnSize.height/2)
		:setTag(UserInfoLayer.BT_MODIFY_PASS)
		:addTo(xiugaimmBg)
		:addTouchEventListener(btcallback)
	--]]
...
function UserInfoLayer:onButtonClickedEvent(tag,ref)
	...
	elseif tag == UserInfoLayer.BT_PROMOTER then
		--local prolayer = PromoterInputLayer:create(self)
		--self:addChild(prolayer)
    elseif tag == UserInfoLayer.BT_PHONE then
		self._scene:onChangeShowMode(yl.SCENE_PHONE)
    elseif tag == UserInfoLayer.BT_MODIFY_PASS then
...
--新 修改后同步大厅 -头像昵称
function UserInfoLayer:onRefreshHN()
	--更新头像
	bGender = (GlobalUserItem.cbGender == yl.GENDER_MANKIND and true or false)
    ...
    self._btPersonInfo:setTexture(_personInfo)
	--刷新大厅 头像 昵称
	self._scene:Refresh_head_nickname()
end
