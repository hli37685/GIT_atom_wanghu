...
{
    NSLog(@"this zml log %@",@"sd1231231");
    NSLog(@"this zml log %lu",[_platformArray count]);
...
- (void) configThirdParty:(NSString*)plat platConfig:(NSDictionary*)config
{
    ...
    else if ([plat isEqualToString:ALIPAY])
    {
        ...
        bRes = (_alipay.AlipayPartnerID != nil);
           ...
           // NSLog(@"configThirdParty  ID = %@",_alipay.AlipayPartnerID);
        ...
        // NSLog(@"configThirdParty KEY= %@",_alipay.AlipayPrivate);
  ...
  - (void) doAliPay:(tagPayParam) param
{
    ...
    if (FALSE == _alipay.Configed)
    {
     ...
     NSString *orderString=param.sOrderId;
    
     NSLog(@"doAliPayorderString = %@",orderString);
