...
function CheckinFrame:sendCheckinQuery()
	...
	local password = GlobalUserItem.szloginPasswords
...
function CheckinFrame:sendCheckMemberGift()
	...
	CheckMemberGift:pushstring(GlobalUserItem.szloginPasswords,33)
...
function CheckinFrame:sendGetMemberGift()
	...
	GetMemberGift:pushstring(GlobalUserItem.szloginPasswords,33)
...
function CheckinFrame:sendBaseEnsureTake()
	...
	BaseEnsureTake:pushstring(GlobalUserItem.szloginPasswords,33)
