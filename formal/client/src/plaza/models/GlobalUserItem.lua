...
function GlobalUserItem.reSetData()
	...
	-- 以下是新添加的
		GlobalUserItem.cbShowServerStatus                    	= 0	
			GlobalUserItem.szloginPassword								= ""	
...
local datalen1 = pData:getlen()

print("GlobalUserItem-LoadData:"..datalen1)
...
GlobalUserItem.dwLoveLiness = pData:readdword()--GlobalUserItem:readScore(pData)

GlobalUserItem.szAccount = pData:readstring(32)
GlobalUserItem.szNickName = pData:readstring(32)
GlobalUserItem.szloginPasswords= pData:readstring(33)

print("=================================================================onLoadData",wFaceID,cbGender,dwCustomID)

GlobalUserItem.szDynamicPass= pData:readstring(33)

print("GlobalUserItem-LoadData2:"..GlobalUserItem.szloginPasswords)
...
function GlobalUserItem:getSignature(times)
    ...
    pstr = pstr..GlobalUserItem.szDynamicPass..timestr.."idftg16ly12S"
    pstr = md5(pstr)
