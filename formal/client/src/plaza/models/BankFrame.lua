...
cmd:pushstring(GlobalUserItem.szloginPasswords,33)
...
function BankFrame:onEnableBank(szPassword)
	...
	if nil ~= self._gameFrame and self._gameFrame:isSocketServer() then
        ...
        dataBuffer:pushstring(GlobalUserItem.szloginPasswords,33)		buffer:pushstring(md5(szPassword),yl.LEN_PASSWORD)
