...
--测试
--yl.LOGONSERVER							= "game.16yi.com" --@login_ip 正式服
yl.LOGONSERVER							= "game123.16yi.com" --@login_ip 和服务端测试用
--yl.LOGONSERVER							= "game.qqlgame.com" --@login_ip
-- 登陆地址列表
yl.SERVER_LIST = 
{
    "test.16yi.com", --@login_ip
--    "game.qqlgame.com"
...
--yl.HTTP_URL								= "http://ry.webfox.com" --@http_url
yl.HTTP_URL								= "http://www.16yi.com" --@http_url
