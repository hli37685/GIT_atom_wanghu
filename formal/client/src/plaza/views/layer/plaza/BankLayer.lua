...
function BankLayer:ctor(scene, gameFrame)
    ...
    self.MainUI_spriteContentBg = cc.Scale9Sprite:create("public/dialogcontentbg.png")
    self.MainUI_spriteContentBg:setCapInsets(CCRectMake(40,40,42,42))
    self.MainUI_spriteContentBg:setContentSize(cc.size(1000, 350))
    self.MainUI_spriteContentBg:setPosition(yl.WIDTH/2, yl.HEIGHT/2 -30)
    self:addChild(self.MainUI_spriteContentBg)
    self.MainUIs[#self.MainUIs+1] = self.MainUI_spriteContentBg
...
--        self:addChild(sp)
--    end
	self._cbtSaveTake = ccui.CheckBox:create("public/anjinbtn.png","public/anjinbtn.png","public/goldbtn.png","","")
		:move(yl.WIDTH/2,565)
    ...
    self.MainUIs[#self.MainUIs+1] = self._cbtSaveTake

    self.MainUI_banktake = display.newSprite("Bank/tag_bank_take.png")
        :setAnchorPoint(cc.p(0,0))
		:move(60, 15)
		:addTo(self._cbtSaveTake)
    self.MainUIs[#self.MainUIs+1] = self.MainUI_banktake


	--银行赠送
	self._cbtTransfer = ccui.CheckBox:create("public/anjinbtn.png","public/anjinbtn.png","public/goldbtn.png","","")
    ...
    self.MainUIs[#self.MainUIs+1] = self._cbtTransfer

    display.newSprite("Bank/tag_bank_present.png")
        :setAnchorPoint(cc.p(0,0))
		:move(60, 15)
		:addTo(self._cbtTransfer)
...
--    local czjjBg = display.newSprite("public/lianglvbtn.png")
--		:move(990,100)
--        :setVisible(false)
...
--    	:addTouchEventListener(btcallback)
    ...
    --存款按钮
    local cunkuanBg = display.newSprite("public/lanlvbtn.png")
		:move(490,100)
		:addTo(self._takesaveArea)
    local newBtnSize = cunkuanBg:getContentSize()
	ccui.Button:create("Bank/bt_bank_save.png", "Bank/bt_bank_save.png")
		:move(newBtnSize.width/2, newBtnSize.height/2)
		:setTag(BankLayer.BT_SAVE)
		:addTo(cunkuanBg)
        :addTouchEventListener(btcallback)
    --取款按钮
    local qvkuanBg = display.newSprite("public/lianglvbtn.png")
		:move(763,100)
		:addTo(self._takesaveArea)
    ...
    local qrzsBg = display.newSprite("public/lanlvbtn.png")
		:move(625,100)
		:addTo(self._transferArea)

   	ccui.Button:create("Bank/bt_bank_present.png", "Bank/bt_bank_present.png")
		:move(newBtnSize.width/2, newBtnSize.height/2)
    ...
    self._notifyTextPresent = cc.Label:createWithTTF("提示：存入游戏币免手续费，取出将扣除 的手续费。存款无需输入银行密码。", "fonts/round_body.ttf", 24)
								...
								:setTextColor(cc.c4b(136,164,224,255))
								:move(1250/2,38)
    self._notifyTextPresent:setVisible(false)
	--提示区域
...
function BankLayer:initEnableBankLayer()
    ...
    spriteContentLBg:setContentSize(cc.size(900, 400))
    spriteContentLBg:setPosition(yl.WIDTH/2, yl.HEIGHT/2)
    self._enableLayer:addChild(spriteContentLBg)
...
--        :addTouchEventListener(btcallback)
    ...
    local btnOKBg = display.newSprite("public/lanlvbtn.png")
		:move(yl.WIDTH/2,120)
		:addTo(self._enableLayer)
    local newBtnSize = btnOKBg:getContentSize()
