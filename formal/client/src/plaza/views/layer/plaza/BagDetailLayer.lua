...
--			:addTouchEventListener(self._btcallback)
    ...
    btnPresentBg:setPosition(yl.WIDTH/2 - 200,128)
    self:addChild(btnPresentBg)

    local newBtnSize = btnPresentBg:getContentSize()
	ccui.Button:create("Bag/bt_present.png","Bag/bt_present.png")
	...
	ccui.Button:create("Bag/bt_use.png","Bag/bt_use.png")
		:move(newBtnSize.width/2, newBtnSize.height/2)
		:setTag(BagDetailLayer.BT_USE)
		:addTo(btnUseBg)
		:addTouchEventListener(self._btcallback)
...
--	display.newSprite("public/srkdt.png")
--			:move(853,460)
--			:addTo(self)
    ...
    spriteNumBg:setPosition(853,460)
	...
	self._txtBuy = cc.LabelAtlas:_create("1", "Shop/Detail/num_detail_0.png", 19, 25, string.byte("."))
    		...
    		:addTo(self)
    local spriteUseBg = cc.Scale9Sprite:create("public/srkdt.png")
    spriteUseBg:setCapInsets(CCRectMake(40,15,351,52))
    spriteUseBg:setContentSize(cc.size(481, 49))
    spriteUseBg:setPosition(853,360)
    self:addChild(spriteUseBg)
--    display.newSprite("public/srkdt.png")
--			:move(853,360)
--			:addTo(self)
