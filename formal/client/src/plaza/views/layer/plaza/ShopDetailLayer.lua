...
function ShopDetailLayer:ctor(scene, gameFrame, name)
	local this = self
...
--    	:addTo(self)
    ...
    spriteContentLBg:setContentSize(cc.size(280, 400))
    spriteContentLBg:setPosition(yl.WIDTH/2-360, yl.HEIGHT/2 + 15)
    ...
    if name == "shop_score_buy" then
        titleSprite =  "Shop/Detail/buygold.png"
    elseif name == "shop_vip_buy" then
        titleSprite =  "Shop/Detail/buyvip.png"
    elseif name == "shop_prop_buy" then
        titleSprite =  "Shop/Detail/buyspeaker.png"
    elseif name == "shop_prop_buy" then
        titleSprite =  "Shop/Detail/buyspeaker.png"
    else
        titleSprite = nil
...
--    end
	...
	if self._item.bean ~= 0 then
		cc.Label:createWithTTF(string.formatNumberThousands(self._item.bean,true,",").."乐豆", "fonts/round_body.ttf", 24)
...
--			:addTouchEventListener(self._btcallback)
    ...
    local btnBuyBg = cc.Scale9Sprite:create("public/lanlvbtn.png")
    btnBuyBg:setCapInsets(CCRectMake(20,10,66,27))
    btnBuyBg:setPosition(yl.WIDTH/2 - 200,128)
    self:addChild(btnBuyBg)

    local newBtnSize = btnBuyBg:getContentSize()
	ccui.Button:create("Shop/Detail/bt_detail_0.png","Shop/Detail/bt_detail_0.png")
		:move(newBtnSize.width/2, newBtnSize.height/2)
		:setTag(ShopDetailLayer.BT_BUY1)
		:addTo(btnBuyBg)
		:addTouchEventListener(self._btcallback)

    local btnUseBg = cc.Scale9Sprite:create("public/lianglvbtn.png")
    btnUseBg:setCapInsets(CCRectMake(20,10,66,27))
    btnUseBg:setPosition(yl.WIDTH/2 + 200,128)
    self:addChild(btnUseBg)

	ccui.Button:create("Shop/Detail/bt_detail_1.png","Shop/Detail/bt_detail_1.png")
		:move(newBtnSize.width/2, newBtnSize.height/2)
		:setTag(ShopDetailLayer.BT_BUY2)
		:addTo(btnUseBg)
		:addTouchEventListener(self._btcallback)
...
--			:addTo(self)
    ...
    spriteNumBg:setPosition(910,509)
