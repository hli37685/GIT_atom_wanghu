...
if modulestr == "yule/oxex/" or modulestr == "yule/oxnew/" or modulestr == "yule/oxsixex/" or modulestr == "yule/watermargin/"  or modulestr == "yule/zhajinhua/" or modulestr == "yule/fishyqs/" or modulestr == "yule/fishlk/" then
if idx==0 then
wRoom=1
elseif idx==1 then
wRoom=2
