...
--		:addTo(self)
    ...
    -- 背景
    self.spriteMainBg = cc.Scale9Sprite:create("public/dialogframe.png")
    ...
    self.spriteContentBg = cc.Scale9Sprite:create("public/dialogcontentbg.png")
    self.spriteContentBg:setCapInsets(CCRectMake(40,40,42,42))
    self.spriteContentBg:setContentSize(cc.size(700, 270))
    self.spriteContentBg:setPosition(appdf.WIDTH/2, appdf.HEIGHT/2+ 20)
    self:addChild(self.spriteContentBg)


	--标题
	self.title = display.newSprite("public/sysmsgtitle.png")
		:move(appdf.WIDTH/2,appdf.HEIGHT-180)
		:addTo(self)


	--返回
	ccui.Button:create("public/closebtn.png","public/closebtn.png")
    	:move(1050,appdf.HEIGHT-200)
